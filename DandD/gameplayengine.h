...
public:
	...
	Monster* getCurrentMovingMonster(){ return currentMovingMonster; }; //! Returns reference to the monster that has most recently been moved
};
