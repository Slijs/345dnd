...
int main() {
	...
	CharacterView *myView = new CharacterView(myChar);
	...
	do {
		...
		cin >> conf;
		switch (conf) {
		case '1': // User wants to modify inventory
			modifyInventory(myChar, myView);
			break;
		case '2': // User wants to add experience points
			addExp(myChar);
			break;
		case '3': // User wants to inflict damage to the Character
...
static void displayMenu() {
	...
	cout << "   [2] - Add experience points." << endl;
